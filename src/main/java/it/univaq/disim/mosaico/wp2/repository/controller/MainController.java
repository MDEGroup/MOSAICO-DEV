...
import it.univaq.disim.mosaico.wp2.repository.repository.EmployeeNotFoundException;
...
public class MainController {
    ...
    @Autowired
    /*
     * This class is used to handle HTTP requests and responses for the Model entity.
     * It uses the ModelRepository to perform CRUD operations on the Model entity.
     */
    private final ModelRepository repository;

    /*
     * This constructor is used to inject the ModelRepository dependency into the MainController class.
  ...
  /*
   * This method handles PUT requests to update an existing model in the repository.
